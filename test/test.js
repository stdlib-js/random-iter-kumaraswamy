...
tape( 'the function throws an error if first shape parameter `a` is not a positive number', function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if second shape parameter `b` is not a positive number', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns an iterator for generating pseudorandom numbers from Kumaraswamy\'s double bounded distribution', function test( t ) {
	var rand;
	var it;
	var i;

	// Note: we assume that the underlying generator is the following PRNG...
	rand = kumaraswamy( 2.0, 5.0, {
		'seed': 12345
	});
